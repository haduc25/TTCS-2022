     <div class="row">
                ...
                <?php	
                    ...
                    ?>
                        <tr class="table-border">
                            ...
                            <td><?=$prd_1->sl_sp ?></td>
                            <td><a href="login/edit?id=<?=$prd_1->id_sp?>" class="btn btn-admin">Chỉnh sửa</a></td>
                ...
                <?php	
                    ...
                    ?>
                        <tr class="table-border">
                            ...
                            <td><?=$prd_2->sl_sp ?></td>
                            <td><a href="login/edit?id=<?=$prd_2->id_sp?>" class="btn btn-admin">Chỉnh sửa</a></td>
        ...
        <!-- bang 4 -->
        <h3 class="info-box-text mgl-28 mgt-50 span-txt mgb-24">4. Apple Watch</h3>
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    <th scope="col" class="pl-15"></th>
                ...
                <?php	
                    ...
                    ?>
                        <tr class="table-border">
                            ...
                            <?php /*var_dump($products_1[0]->id_sp); exit;*/ ?>
                            <td><?=$prd_4->ten_sp ?></td>
                            <td><?=$prd_4->sub_ten_sp ?></td>
                            <td><img src="../<?= $prd_4->img_sp ?>" alt="<?=$prd_4->ten_sp ?>" width="150"></td>
                            <td><?=$prd_4->sl_sp ?></td>
                            <td><a href="login/edit?id=<?=$prd_4->id_sp?>" class="btn btn-admin">Chỉnh sửa</a></td>
                            <td><a href="login/del?id=<?=$prd_4->id_sp?>" class="btn btn-admin">Xóa</a></td>
                        </tr>
                <?php } ?>
